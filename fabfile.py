"""
Starter fabfile for deploying the cmsbase project.
...
# CHANGEME
env.hosts = ['user@cmsbase.example.com']
env.code_dir = '/srv/www/cmsbase'
env.project_dir = '/srv/www/cmsbase/cmsbase'
env.static_root = '/srv/www/cmsbase/static/'
env.virtualenv = '/srv/www/cmsbase/.virtualenv'
env.code_repo = 'git@github.com:user/cmsbase.git'
env.django_settings_module = 'cmsbase.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/cmsbase/wsgi.py" % env.code_dir)
