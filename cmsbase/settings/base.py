...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'cmsbase.settings.base.custom_show_toolbar',
...
WSGI_APPLICATION = 'cmsbase.wsgi.application'
...
SYSTEM_EMAIL_PREFIX = "[cmsbase]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_cmsbase"  # Make this unique to your project.
